...
async function createTransfer({
  ...
  if (existingTransaction) {
    const sameTransaction =
      ...
      existingTransaction.currency === "INR" &&
      String(existingTransaction.fromAccount) === String(fromAccountId) &&
      String(existingTransaction.toAccount) === String(toAccountId) &&
      existingTransaction.amountMinor === amountMinor;
